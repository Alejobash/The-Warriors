...
Fontrans=pygame.image.load("imagenes/nube.jpg")
...
class Nivel(object):
    ...
    def draw(self,pantalla):
        ...
        pantalla.blit(self.fondo2,(self.rect1.x+800,self.rect1.y))
        pantalla.blit(self.fondo2,(self.rect1.x+1600,self.rect1.y))
        pantalla.blit(self.fondo2,(self.rect1.x+2400,self.rect1.y))
...
def main():
    pygame.init()
    pygame.mixer.init()
    fuente= pygame.font.Font("fuentes/Doom Submenu.ttf", 30)
    fuentep=pygame.font.Font("fuentes/Doom Submenu.ttf",12)
    ...
    while not fin:
        ...
        if tipobul==0:
            txt_plasma=fuentep.render("Arma actual: BFG9000",True,ROJO)
            pantalla.blit(txt_plasma,[10,30])
            txt_info=fuentep.render("Arma semi, dano masivo",True,ROJO)
            pantalla.blit(txt_info,[10,50])
            txt_info=fuentep.render("Plasma usado: 10",True,ROJO)
            pantalla.blit(txt_info,[10,70])
        if tipobul==1:
            txt_plasma=fuentep.render("Arma actual: Rifle de Plasma",True,ROJO)
            pantalla.blit(txt_plasma,[10,30])
            txt_info=fuentep.render("Arma automatica, con buen dano",True,ROJO)
            pantalla.blit(txt_info,[10,50])
            txt_info=fuentep.render("Plasma usado: 2",True,ROJO)
            pantalla.blit(txt_info,[10,70])
